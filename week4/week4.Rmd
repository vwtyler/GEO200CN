...
> Perhaps it's hard to tell in the data collection. The spectral signatures for confier and desert could be more distinct than that of hardwood, herbaceous, and desert. 
...
> Create a random raster using the same classes and compare it to the observed distribution of classes?
