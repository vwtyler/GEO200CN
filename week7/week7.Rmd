...
#but why is this with not the training data?
...
> Looking at the plot comparisons, the second order polynomial + interactions model (poly + int) has the lowest RMSE. This would give us a model with high predictive power and but with high variance. However, the interaction model has the lowest AIC, which would give us a conservative model with lower predictive power, but lower variance and more inferential power.
